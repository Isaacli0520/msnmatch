...
urlpatterns = [
	...
	path('api/get_trending_courses/', views.get_trending_courses, name='get_trending_courses'),
	path('api/get_recommendations/', views.get_recommendations, name='get_recommendations'),
	path('api/get_major_options/', views.get_major_options, name='get_major_options'),
	path('api/get_current_semester/', views.get_current_semester, name='get_current_semester'),
