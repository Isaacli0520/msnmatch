...
MAJORS = ["Aerospace Engineering",
    ...
    "Speech Communication Disorders (BSEd)",
    "Statistics",
    "Studio Art",
    "Systems Engineering",
...
MAJOR_CHOICES = [(i, i) for i in MAJORS]
MINOR_CHOICES = [(i, i) for i in MINORS + MAJORS]
...
def get_user():
    ...
    user = User.objects.get_or_create(username="default")
    return user
